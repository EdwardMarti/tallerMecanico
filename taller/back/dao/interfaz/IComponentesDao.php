...
interface IComponentesDao {
  ...
  public function select($componentes);
    /**
     * Lista todos los objetos Componentes en la base de datos.
     * @return Array<Componentes> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
