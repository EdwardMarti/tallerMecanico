...
interface IAdministradorsDao {
  ...
  public function select($administradors);
    /**
     * Lista todos los objetos Administradors en la base de datos.
     * @return Array<Administradors> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
