...
interface IMecanicosDao {
  ...
  public function select($mecanicos);
    /**
     * Lista todos los objetos Mecanicos en la base de datos.
     * @return Array<Mecanicos> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
