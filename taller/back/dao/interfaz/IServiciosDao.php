...
interface IServiciosDao {
  ...
  public function select($servicios);
    /**
     * Lista todos los objetos Servicios en la base de datos.
     * @return Array<Servicios> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
